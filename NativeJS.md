...
console.log([3, 4] * 5); // NaN - / * не переопределены для работы с объектами и строками
console.log({ s: 3, d: 4 } * 5); // NaN (- / * не переопределены для работы с объектами и строками)
